// frontend/src/components/profile/PhotoManagement.js
...
const PhotoManagement = ({ onPhotoChange }) => {
    ...
    const handleDeletePhoto = async (photoId, isProfile) => {
        // Confirm before deleting
        if (!window.confirm(isProfile ?
            'Are you sure you want to delete your profile photo? You will need to set a new one.' :
                                ...
                                <div key={photo.photo_id} className="relative group">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 flex items-center justify-center transition-opacity duration-200 opacity-0 group-hover:opacity-100">
                                        <div className="flex space-x-2">
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => handleDeletePhoto(photo.photo_id, photo.is_profile)}
